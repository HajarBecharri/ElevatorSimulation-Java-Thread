...
public class Personne implements Runnable {
    ...
    public Personne(String nom, int etageAriv, int etageActu, Ascenceur ascenseur,IGAscenseur UG,String ascCot) {
        this.nom = nom;
    ...
    timer=this.nom+" : Attendre à l'etage "+this.etageActu+":"+this.ascCot;
    UG.setText(timer);
    UG.setImage("C:\\ascA.jpeg");
        try {
    
    this.rentrer();
    timer=this.nom+" : Entre à l'etage "+ascenseur.etageActu+":"+this.ascCot;
    UG.setText(timer);
    ...
    timer=this.nom+" : sort à l'étage"+ ascenseur.etageActu+":"+this.ascCot;
    UG.setText(timer);
